from schema import SkillMatch, VacancyDetails

def get_vacancy_details(vacancy_id: str) -> VacancyDetails:
...
def get_metrics(vacancy_id: str):
    pass

# Основа Йоу
def get_top_vacancies(raw_resume: str):

    vacancy_details = get_vacancy_details(vacancy_id = '1')
